...
open class BMInputBox: UIView {
    ...
    open var submitButtonText: String?
     ...
     */
    open var validationLabelText: String?

    /// UILabel for displaying the validation message
    fileprivate var validationLabel: UILabel!
     ...
     */
    @objc open class func boxWithStyle (_ style: BMInputBoxStyle) -> BMInputBox {
    ...
    fileprivate func setupView () {
        ...
        case .plainTextInput, .numberInput, .emailInput, .secureTextInput, .phoneNumberInput:
            ...
            if self.customiseInputElement != nil {
                self.textInput = self.customiseInputElement(self.textInput! as UITextField)
            }
        ...
        case .loginAndPasswordInput:
            ...
            // Allow customisation
            if self.customiseInputElement != nil {
                self.secureInput = self.customiseInputElement(self.secureInput! as UITextField)
            }
        ...
        if self.style == .numberInput {
            ...
            if (self.minimumValue != nil && self.maximumValue == nil) {
                self.validationLabel.text = String(format: messageString ?? "A value greater than %@.", self.minimumValue!) as String
            }
            else if (self.minimumValue == nil && self.maximumValue != nil) {
                self.validationLabel.text = String(format: messageString ?? "A value lower than %@.", self.maximumValue!) as String
            }
            else if (self.minimumValue != nil && self.maximumValue != nil) {
    ...
    open var customiseInputElement: ((_ element: UITextField) -> UITextField)!
    ...
    fileprivate func yCorrection () -> CGFloat {
    ...
    fileprivate func resetFrame (_ animated: Bool) {
